    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-base md:text-lg text-[var(--light-text)] mb-10 max-w-2xl mx-auto">
          15+ лет в IT, реальные внедрения в маркетплейсах Восточной Европы, medtech и e-commerce. Помогаем SMB и руководителям команд - от личного ассистента и голосовых агентов до автоматизации обработки обращений и воронок.
        </p>
